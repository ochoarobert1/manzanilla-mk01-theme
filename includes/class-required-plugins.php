<?php
add_action( 'tgmpa_register', 'manzanilla_register_required_plugins' );
 ...
 */
function manzanilla_register_required_plugins() {
    /*
     ...
     */
    $config = array(
        'id'           => 'manzanilla_tgmpa',                 // Unique ID for hashing notices for multiple instances of TGMPA.
