...
function manzanilla_load_css() {
    ...
    if (!is_admin()){
        ...
        /*- GOOGLE FONTS -*/
        wp_register_style('google-fonts', 'https://fonts.googleapis.com/css2?family=Prata&family=Work+Sans:wght@300;400;500;600;700;800;900&display=swap', false, $version_remove, 'all');
